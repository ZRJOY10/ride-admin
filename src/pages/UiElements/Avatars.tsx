...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | campus_ride - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for campus_ride - React.js Tailwind CSS Admin Dashboard Template"
      />
