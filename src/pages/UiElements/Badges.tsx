...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | campus_ride - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for campus_ride - React.js Tailwind CSS Admin Dashboard Template"
      />
