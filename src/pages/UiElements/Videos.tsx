...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | campus_ride - React.js Admin Dashboard Template"
        description="This is React.js Videos page for campus_ride - React.js Tailwind CSS Admin Dashboard Template"
      />
